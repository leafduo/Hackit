...
- (void)setPost:(FHIPost *)post {
  ...
  self.subtextlabel.text = [NSString
      stringWithFormat:@"%d points %@", post.point, [_post.createDate timeAgo]];
  ...
  if (_post.starred) {
    [_starButton
        setTintColor:
            [UIColor colorWithHue:0.067 saturation:1 brightness:1 alpha:1]];
  } else {
